...
class MainDatasetUtilityGenerator {
    ...
    private static void generateDataset(
        ...
        BufferedReader myInput = new BufferedReader(new InputStreamReader(MainDatasetUtilityGenerator.class.getResourceAsStream(input)));
        ...
        myInput = new BufferedReader(new InputStreamReader(MainDatasetUtilityGenerator.class.getClassLoader().getResourceAsStream(input)));
        // for each line (transaction) until the end of file
        while ((thisLine = myInput.readLine()) != null) {
            // if the line is  a comment, is  empty or is a
            // kind of metadata
