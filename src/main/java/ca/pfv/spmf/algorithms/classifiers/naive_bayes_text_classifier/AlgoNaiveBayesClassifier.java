...
public class AlgoNaiveBayesClassifier {
    ...
    private void runAlgorithm() throws Exception {
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File(this.getClass().getClassLoader().getResource(mOutputDirectory + "/output.tsv").toURI()))));
        ...
        File[] listOfTestFiles = new File(this.getClass().getClassLoader().getResource(mTestDataDirectory).toURI()).listFiles();
        File[] listOfTrainingFiles = new File(this.getClass().getClassLoader().getResource(mTrainingDataDirectory).toURI()).listFiles();
        ...
        for (File f : listOfTrainingFiles) {
            ...
            op.add(oc);
            File classTraining[] = new File(this.getClass().getClassLoader().getResource(mTrainingDataDirectory + "/" + f.getName()).toURI()).listFiles();
