 ...
 * This feature is used when an ca.pfv.spmf.input file is converted from ARFF or TEXT to the integer format.
 * After that, when an ca.pfv.spmf.algorithms is applied, the result is in integer format
 ...
 * between integer and strings that is stored in the converted ca.pfv.spmf.input file.
 * 
...
class MainTestResultConverter {
	...
	public static void main(String [] arg) throws IOException{
		...
		// the ca.pfv.spmf.input file in integer format that contain metadata about
