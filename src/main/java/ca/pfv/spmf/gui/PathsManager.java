...
public class PathsManager {   
	...
	// for ca.pfv.spmf.input and output files.
    public static final String REGKEY_SPMF_INPUT_FILE = "ca.pfv.spmf.ca.pfv.spmf.gui.ca.pfv.spmf.input";
    public static final String REGKEY_SPMF_OUTPUT_FILE = "ca.pfv.spmf.ca.pfv.spmf.gui.output";
    ...
    /**
     * Get the ca.pfv.spmf.input file path stored in the registry
    ...
    /**
     * Store an ca.pfv.spmf.input file path in the registry
