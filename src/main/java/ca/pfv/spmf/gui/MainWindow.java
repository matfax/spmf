...
public class MainWindow extends JFrame implements ThreadCompleteListener, UncaughtExceptionHandler {
    ...
    public MainWindow() throws Exception {
        ...
        // Combo box to store the list of ca.pfv.spmf.algorithms.
        comboBox = new JComboBox<String>(new Vector<String>());
        comboBox.setMaximumRowCount(20);

        //************************************************************************
        //********* Use the algorithm manager to populate the list of ca.pfv.spmf.algorithms ******* //
        comboBox.addItem("");
        ...
        lblChooseInputFile = new JLabel("Choose ca.pfv.spmf.input file");
     ...
     * in the list of ca.pfv.spmf.algorithms. For example, if the user choose the "PrefixSpan" algorithm
...
//    }
     ...
     * when the user change ca.pfv.spmf.algorithms or when the JFrame is first created.
     */
...
//		.setVisible(false);
    ...
    /**
     * This method ask the user to choose the ca.pfv.spmf.input file. This method is
     * called when the user click on the button to choose the ca.pfv.spmf.input file.
     */
	private void askUserToChooseInputFile() {
		try {
		    ...
		    JOptionPane.showMessageDialog(null,
		            "An error occured while opening the ca.pfv.spmf.input file dialog. ERROR MESSAGE = " + e.toString(), "Error",
     ...
     * called when the user click on the button to choose the ca.pfv.spmf.input file of the S P M F interface.
     */
