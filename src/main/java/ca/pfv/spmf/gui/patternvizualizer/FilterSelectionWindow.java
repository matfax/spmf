 ...
 */
/**
 * This is a simple user interface for filtering ca.pfv.spmf.patterns shown by the pattern
 * vizualizer window.
 * 
...
public class FilterSelectionWindow extends JDialog {
	 ...
	 * @param rowFilters the list of filters currently applied on the ca.pfv.spmf.patterns
