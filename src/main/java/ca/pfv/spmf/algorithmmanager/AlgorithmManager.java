 ...
 */
/**
 * This class is used to load the list of all available ca.pfv.spmf.algorithms available in SPMF.
 * 
...
public class AlgorithmManager {
	...
	/** List of ca.pfv.spmf.algorithms available in SPMF */
	...
	private AlgorithmManager() throws Exception {
		// Load all ca.pfv.spmf.algorithms in the package "ca.pfv.spmf.ca.pfv.spmf.algorithms.description."
		algorithms = getDescriptionOfAlgorithmsInPackage("ca.pfv.spmf.ca.pfv.spmf.algorithmmanager.descriptions.");

		// Then we should load ca.pfv.spmf.algorithms from Jar files in the same folder if required
		//....
		
		// Then, we will sort the list of ca.pfv.spmf.algorithms by categories.
	...
	/**
	 * Get the list of ca.pfv.spmf.algorithms as String as displayed by the user interface of SPMF. The name of the first category appears,
	 * followed by the list of ca.pfv.spmf.algorithms in the first category. Then, it is followed by the second category and so on...
	 * @return the list of ca.pfv.spmf.algorithms as String
	 */
	public List<String> getListOfAlgorithmsAsString() {
		...
		for(DescriptionOfAlgorithm algorithm : algorithms){
			// if this algorithm belong to a new category, we will add the category name to the list of ca.pfv.spmf.algorithms
	...
	/**
	 * Get the description of all ca.pfv.spmf.algorithms in a given package name, from a jar or not
	 ...
	 * @throws Exception if an error occurs while looking for the descriptions of ca.pfv.spmf.algorithms
	 */
...
//				"C:/Users/phil/Desktop/spmf.jar", "ca.pfv.spmf.ca.pfv.spmf.algorithms");
//		System.out.println(list);
//		/*
//		 * output :
//		 * 
//		 * Jar C:/Users/phil/Desktop/spmf.jar looking for ca/pfv/spmf/ca.pfv.spmf.algorithms
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.ArraysAlgos$1.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.ArraysAlgos.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.ItemNameConverter.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.IGB.AlgoIGB.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.Indirect.AlgoINDIRECT$1.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.Indirect.AlgoINDIRECT.class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.MNRRules.AlgoMNRRules.class
//		 * ca
//		 * .pfv.spmf.ca.pfv.spmf.algorithms.associationrules.TopKRules_and_TNR.AlgoTopKRules
//		 * .class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.TopKRules_and_TNR.AlgoTNR
//		 * .class
//		 * ca.pfv.spmf.ca.pfv.spmf.algorithms.associationrules.TopKRules_and_TNR.RuleG.class
//		 * ....
//		 */
//	 }
