 ...
 */
public class DescriptionAlgoFCHM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoFCHM(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/documentation.php#fchm";
	}
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Correlated ca.pfv.spmf.patterns", "High-utility ca.pfv.spmf.patterns","High-utility itemsets","Correlated High-utility itemsets"};
	}
