...
public class DescriptionAlgoEFIMClosed extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns",  "Closed ca.pfv.spmf.patterns","High-utility ca.pfv.spmf.patterns","Closed itemsets","High-utility itemsets","Closed high-utility itemsets"};
	}
