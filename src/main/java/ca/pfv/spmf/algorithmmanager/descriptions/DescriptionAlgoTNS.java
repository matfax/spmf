...
public class DescriptionAlgoTNS extends DescriptionOfAlgorithm {
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[0] = new DescriptionOfParameter("k", "(e.g. 3 ca.pfv.spmf.patterns)", Integer.class, false);
		parameters[1] = new DescriptionOfParameter("Minconf (%)", "(e.g. 0.8 or 80%)", Double.class, false);
		parameters[2] = new DescriptionOfParameter("Delta", "(e.g. 2 ca.pfv.spmf.patterns)", Integer.class, false);
		return parameters;
	}
