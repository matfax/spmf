...
public class DescriptionAlgoCMSPADE extends DescriptionOfAlgorithm {
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#cmspade";
	}
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Frequent sequential ca.pfv.spmf.patterns"};
	}
