...
public class DescriptionAlgoGHUIMiner extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns",  "Generator ca.pfv.spmf.patterns","High-utility ca.pfv.spmf.patterns","Generator itemsets","High-utility itemsets","Generators of high-utility itemsets"};
	}
