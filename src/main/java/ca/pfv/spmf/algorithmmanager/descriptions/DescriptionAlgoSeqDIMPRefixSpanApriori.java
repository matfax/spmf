...
public class DescriptionAlgoSeqDIMPRefixSpanApriori extends DescriptionOfAlgorithm {
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		// does not
		// perform very well. Other ca.pfv.spmf.algorithms could be added.
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Frequent sequential ca.pfv.spmf.patterns", "Multi-dimensional frequent sequential ca.pfv.spmf.patterns"};
	}
//
//	@Override
