...
public class DescriptionAlgoPFPM extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Frequent ca.pfv.spmf.patterns", "Periodic ca.pfv.spmf.patterns", "Periodic frequent ca.pfv.spmf.patterns", "Periodic frequent itemsets"};
	}
