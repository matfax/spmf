 ...
 * by Antonio G.P. which applies post-processing to find closed sequential ca.pfv.spmf.patterns).
...
public class DescriptionAlgoPrefixSpanPostprocessingClosed extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Frequent closed sequential ca.pfv.spmf.patterns"};
	}
