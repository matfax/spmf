...
public class DescriptionAlgoTSP extends DescriptionOfAlgorithm {
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[0] = new DescriptionOfParameter("k ", "(e.g. 5 ca.pfv.spmf.patterns)", Double.class, false);
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Top-k frequent sequential ca.pfv.spmf.patterns"};
	}
