...
public class DescriptionAlgoUSpan extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "High-utility ca.pfv.spmf.patterns","Sequential ca.pfv.spmf.patterns", "High-utility ca.pfv.spmf.patterns", "High-utility sequential ca.pfv.spmf.patterns"};
	}
//
//	@Override
