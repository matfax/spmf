...
public class DescriptionAlgoHirateYamana extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Frequent Sequential ca.pfv.spmf.patterns", "Frequent sequential ca.pfv.spmf.patterns with timestamps"};
	}
