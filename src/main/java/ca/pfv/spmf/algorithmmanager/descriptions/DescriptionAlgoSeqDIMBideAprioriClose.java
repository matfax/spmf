...
public class DescriptionAlgoSeqDIMBideAprioriClose extends DescriptionOfAlgorithm {
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns", "Sequential ca.pfv.spmf.patterns", "Frequent sequential ca.pfv.spmf.patterns", "Multi-dimensional frequent closed sequential ca.pfv.spmf.patterns"};
	}
//
//	@Override
