...
public class MainTestAlgorithmManager {
	...
	public static void main(String[] args) throws Exception {
		...
		// First example:  Get the list of all ca.pfv.spmf.algorithms by categories
		System.out.println("========= Printing the list of ca.pfv.spmf.algorithms sorted by categories ========");
		System.out.println();
		...
		System.out.println("Types of ca.pfv.spmf.input file : " + Arrays.toString(descriptionOfAlgorithm.getInputFileTypes()));
